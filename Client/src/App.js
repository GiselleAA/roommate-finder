  ...
  return (
    <div>
      <form className='mx-auto px-5 pt-5 pb-3 rounded-2xl bg-theme-orange w-72 mt-36 h-84' onSubmit={submitHandler}>
        ...
        <input className='w-full h-8 p-1 mb-3 rounded-lg focus:outline-none' id='username' type='text' value={username} onChange={(e) => setUsername(e.target.value)} />
        ...
        <div className='flex justify-center'>
          <button className='px-3 py-1 p rounded-lg bg-theme-purple text-black' type='submit'>Sign In</button>
        </div>
